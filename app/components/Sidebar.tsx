...
export default function Sidebar({ chatHistory, onSelectChat, onNewChat }: SidebarProps) {
  const { theme, setTheme } = useTheme();
  const { isCollapsed, toggleCollapse, isMobileOpen, setIsMobileOpen, isMobile } = useSidebar();
